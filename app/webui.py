...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .link-btn { border: none; background: none; color: var(--muted); cursor: pointer;
              padding: 2px 6px; font-size: 0.8rem; font-weight: 600; }
  .link-btn:hover { color: var(--red); background: none; }
